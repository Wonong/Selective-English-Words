function varargout = wordtesteng_additional_plan(varargin)
% WORDTESTENG_ADDITIONAL_PLAN MATLAB code for wordtesteng_additional_plan.fig
%      WORDTESTENG_ADDITIONAL_PLAN, by itself, creates a new WORDTESTENG_ADDITIONAL_PLAN or raises the existing
%      singleton*.
%
%      H = WORDTESTENG_ADDITIONAL_PLAN returns the handle to a new WORDTESTENG_ADDITIONAL_PLAN or the handle to
%      the existing singleton*.
%
%      WORDTESTENG_ADDITIONAL_PLAN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WORDTESTENG_ADDITIONAL_PLAN.M with the given input arguments.
%
%      WORDTESTENG_ADDITIONAL_PLAN('Property','Value',...) creates a new WORDTESTENG_ADDITIONAL_PLAN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wordtesteng_additional_plan_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wordtesteng_additional_plan_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wordtesteng_additional_plan

% Last Modified by GUIDE v2.5 12-Dec-2013 16:14:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wordtesteng_additional_plan_OpeningFcn, ...
                   'gui_OutputFcn',  @wordtesteng_additional_plan_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wordtesteng_additional_plan is made visible.
function wordtesteng_additional_plan_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wordtesteng_additional_plan (see VARARGIN)

% Choose default command line output for wordtesteng_additional_plan
...
% UIWAIT makes wordtesteng_additional_plan wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wordtesteng_additional_plan_OutputFcn(hObject, eventdata, handles) 
...
if(word_ind_engtest_ap==handles.mydata.word_size+1)
    ...
    wordtestline_additional_plan(handles.mydata.user_name, handles.mydata.word_list, handles.mydata.point, handles.mydata.user_additional);
