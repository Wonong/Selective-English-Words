function varargout = wordtestresult_additional_re(varargin)
% WORDTESTRESULT_ADDITIONAL_RE MATLAB code for wordtestresult_additional_re.fig
%      WORDTESTRESULT_ADDITIONAL_RE, by itself, creates a new WORDTESTRESULT_ADDITIONAL_RE or raises the existing
%      singleton*.
%
%      H = WORDTESTRESULT_ADDITIONAL_RE returns the handle to a new WORDTESTRESULT_ADDITIONAL_RE or the handle to
%      the existing singleton*.
%
%      WORDTESTRESULT_ADDITIONAL_RE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WORDTESTRESULT_ADDITIONAL_RE.M with the given input arguments.
%
%      WORDTESTRESULT_ADDITIONAL_RE('Property','Value',...) creates a new WORDTESTRESULT_ADDITIONAL_RE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wordtestresult_additional_re_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wordtestresult_additional_re_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wordtestresult_additional_re

% Last Modified by GUIDE v2.5 12-Dec-2013 19:55:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wordtestresult_additional_re_OpeningFcn, ...
                   'gui_OutputFcn',  @wordtestresult_additional_re_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wordtestresult_additional_re is made visible.
function wordtestresult_additional_re_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wordtestresult_additional_re (see VARARGIN)

% Choose default command line output for wordtestresult_additional_re
...
% UIWAIT makes wordtestresult_additional_re wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wordtestresult_additional_re_OutputFcn(hObject, eventdata, handles) 
...
fid=fopen(strcat('./temp/',handles.mydata.user_additional, '.day'),'w');
