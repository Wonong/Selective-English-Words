function varargout = wordtestkor_additional_re(varargin)
% WORDTESTKOR_ADDITIONAL_RE MATLAB code for wordtestkor_additional_re.fig
%      WORDTESTKOR_ADDITIONAL_RE, by itself, creates a new WORDTESTKOR_ADDITIONAL_RE or raises the existing
%      singleton*.
%
%      H = WORDTESTKOR_ADDITIONAL_RE returns the handle to a new WORDTESTKOR_ADDITIONAL_RE or the handle to
%      the existing singleton*.
%
%      WORDTESTKOR_ADDITIONAL_RE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WORDTESTKOR_ADDITIONAL_RE.M with the given input arguments.
%
%      WORDTESTKOR_ADDITIONAL_RE('Property','Value',...) creates a new WORDTESTKOR_ADDITIONAL_RE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wordtestkor_additional_re_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wordtestkor_additional_re_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wordtestkor_additional_re

% Last Modified by GUIDE v2.5 12-Dec-2013 19:51:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wordtestkor_additional_re_OpeningFcn, ...
                   'gui_OutputFcn',  @wordtestkor_additional_re_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wordtestkor_additional_re is made visible.
function wordtestkor_additional_re_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wordtestkor_additional_re (see VARARGIN)

% Choose default command line output for wordtestkor_additional_re
...
% UIWAIT makes wordtestkor_additional_re wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wordtestkor_additional_re_OutputFcn(hObject, eventdata, handles) 
...
if(word_ind_kortest_ap==handles.mydata.word_size+1)
    ...
    wordtestresult_additional_re(handles.mydata.user_name, handles.mydata.word_list, handles.mydata.point, handles.mydata.user_additional);
else
    Test(handles);
end
