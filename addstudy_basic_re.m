function varargout = addstudy_basic_re(varargin)
% ADDSTUDY_BASIC_RE MATLAB code for addstudy_basic_re.fig
%      ADDSTUDY_BASIC_RE, by itself, creates a new ADDSTUDY_BASIC_RE or raises the existing
%      singleton*.
%
%      H = ADDSTUDY_BASIC_RE returns the handle to a new ADDSTUDY_BASIC_RE or the handle to
%      the existing singleton*.
%
%      ADDSTUDY_BASIC_RE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ADDSTUDY_BASIC_RE.M with the given input arguments.
%
%      ADDSTUDY_BASIC_RE('Property','Value',...) creates a new ADDSTUDY_BASIC_RE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before addstudy_basic_re_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to addstudy_basic_re_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help addstudy_basic_re

% Last Modified by GUIDE v2.5 12-Dec-2013 20:03:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @addstudy_basic_re_OpeningFcn, ...
                   'gui_OutputFcn',  @addstudy_basic_re_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before addstudy_basic_re is made visible.
function addstudy_basic_re_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to addstudy_basic_re (see VARARGIN)

% Choose default command line output for addstudy_basic_re
...
% UIWAIT makes addstudy_basic_re wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = addstudy_basic_re_OutputFcn(hObject, eventdata, handles) 
